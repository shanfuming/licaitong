...
public class ProjectRecordFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        records.add(new SubscribeRecord("李三","1000.00","13366230910"));
        records.add(new SubscribeRecord("张思","2000.00","13365730910"));
        records.add(new SubscribeRecord("王二麻子","3000.00","13366230450"));
        records.add(new SubscribeRecord("李三","4000.00","13366345910"));
