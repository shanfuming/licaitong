package com.zqzr.licaitong.utils.ref;
...
public class RefObject {
    ...
    public List<RefObject> getAll() throws RefException {
        List<RefObject> list = new LinkedList<RefObject>();
    ...
    public HashMap<String, Object> getField() throws RefException {
        HashMap<String, Object> fieldMap = new HashMap<>();
        List<RefObject>         list     = getAll();
        for (RefObject field : list) {
            Object value = field.unwrap();
            if (value != null) {
                fieldMap.put(field.getName(), field.unwrap());
            }
        }
        return fieldMap;
    }
