...
import com.zqzr.licaitong.http.RequestParams;
import com.zqzr.licaitong.utils.encryption.des.ThreeDESUtil;
import com.zqzr.licaitong.utils.ref.RefException;
import com.zqzr.licaitong.utils.ref.RefObject;
...
public class SPUtil {
    ...
    public static String imeiSave(Context context) {
        SharedPreferences.Editor localEditor = context.getSharedPreferences(RequestParams.ACKAPPKEY, 0).edit();
        ...
        localEditor.putString(RequestParams.ACKTOKEN, imei);
        localEditor.commit();
        return imei;
    }
